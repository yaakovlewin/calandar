                    ...
                    {days.map((day) => (
                        ...
                        >
                            ...
                            {day.hebDate.heDateParts.d && (
                                <p className="absolute top-0 right-0 -mt-1 -mr-1 inline-flex items-center justify-center px-2 py-1 text-xs font-medium leading-none text-black bg-indigo-600 rounded-full">
                                    {day.hebDate.heDateParts.d}
                                </p>
                            )}
                            {day.events.length > 0 && (
